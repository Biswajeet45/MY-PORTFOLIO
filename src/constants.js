...
export const experiences = [
  {
    ...
    company: "TD Bank (Offshore AML Operations)",
    date: "Feb 2026 – Present",
    desc: "Conduct Anti-Money Laundering (AML) investigations for TD Bank by analyzing transactional data, customer profiles, and alerts to identify potential suspicious activities and ensure regulatory compliance. Perform offshore AML case reviews involving KYC validation, transaction monitoring, and risk assessment in accordance with global AML regulatory standards and compliance frameworks.",
    skills: [
      "AML Investigation",
      "KYC",
  ...
  },
  {
    ...
    skills: ["Python", "Excel", "SQL", "PowerBI"],
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    github:
      "https://github.com/Biswajeet45/PBI_DASHBOARD/blob/main/IPL_ANALYSIS_2008_2022.pbix",
  ...
  },
  {
    ...
    tags: ["Python", "SQL", "PowerBI"],
    github:
      "https://github.com/Biswajeet45/PBI_DASHBOARD/blob/main/LINKEDIN_ANALYSIS_DASHBOARD/LINKEDIN_DB.pbix",
