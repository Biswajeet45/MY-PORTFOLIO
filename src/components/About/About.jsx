...
import profileImage from '../../assets/Biswa.png';
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1T3Vw2fXHkGMo-02BGqrLG0ugPSSF5L2p/view?usp=drive_link"
            target="_blank"
        ...
        {/* Right Side */}
        <div className="md:w-1/2 flex justify-center md:justify-end mt-8 md:mt-12 ml-6">
          <Tilt
